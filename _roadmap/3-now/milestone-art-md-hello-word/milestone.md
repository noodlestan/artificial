...
| 2     | Plan: Decompose Codec Demo `$PROJECT/_backlog/4-next/plan-decompose-codec-demo/plan.md`               | `READY` |
...
Delegate plan `decompose-codec-demo`; it is `READY` in `$PROJECT/_backlog/4-next`.
