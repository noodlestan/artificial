...
| `src/private/records/repository/loadRepositoryRecords.ts`           | Now async; calls `findRecordFiles(config.root.path, config.records.pattern, kinds?)`; filters null results                                                |
...
| `src/private/records/checkout/loadCheckoutRecords.ts`               | Now async; calls `findRecordFiles(config.root.path, config.records.pattern, kinds?)`; filters null results                                                |
