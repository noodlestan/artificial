...
- Milestone: `_backlog/4-next/milestone-md-art-roundtrip/milestone.md` – defines this plan as phase 7 of the MD Art Roundtrip milestone; the "Documentation to produce" section lists the architecture docs to seed.
