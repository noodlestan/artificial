...
- `artificials/artisans/apps/art-mantras/_plan.md` — the design contract; read **Layer: Entry Point** (`main`) and **Layer: Persistence** (`loadData`), plus Conventions (`const FILE = "data.json"`, utils → `main()` last).
